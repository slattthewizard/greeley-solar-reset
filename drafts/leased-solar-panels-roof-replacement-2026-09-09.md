---
meta_title: "Leased Solar Panels Roof Replacement: Who Detaches?"
meta_description: "Leased or PPA solar? The provider decides who detaches your panels for a reroof. Owned systems run $200 to $500 per panel. Start the call before you book."
primary_keyword: "leased solar panels roof replacement"
secondary_keywords: "PPA solar roof replacement, who removes leased solar panels, solar lease roof repair, remove leased solar panels for reroof, solar provider panel removal fee"
---

# Leased Solar Panels and Roof Replacement: Who Is Allowed to Detach Them?
...
Here is how to work out what you actually have, what the provider is likely to require, and where our crew fits in. If your system is owned, including owned with a loan still on it, you can skip most of this: you pick your own contractor and normal [detach and reset pricing](/solar-detach-reset-greeley/) applies.
...
1. Call the provider before you sign anything with a roofing company. Ask them, in those words, what their process is for a roof replacement under the array.
2. Find out who is allowed to do the work. Depending on the agreement, that's their own crew, a vendor from their approved list, or an outside solar contractor working with their written sign-off.
3. Ask what the fee is, and get the number in writing. Providers handle this differently and the amount is set by your agreement, not by us.
4. Ask for the lead time in writing too, for the detach and for the reset, and ask what happens if the roof runs long.
5. Only then book the roofer, around the dates the provider gave you.
...
One opinion, freely given: if your shingles are pushing 20 to 25 years and your panels are warrantied for 25 to 30, that mismatch is coming for you no matter what. Starting the provider conversation while the roof is merely old beats starting it while a ceiling is dripping. [Reroofing early with panels on the roof](/blog/old-roof-with-solar-panels/) is the cheaper version of this problem.
...
Watch the low quote. The cheapest number in the pile has usually left something out, and on this job the thing left out is flashing at the new mount penetrations. There are legitimate reasons [quotes vary](/blog/why-solar-detach-reset-quotes-vary/), and there are reasons that show up as a stain on your ceiling in April. If Tesla or SolarCity installed your system, ask them directly who is allowed to service it, and read our separate piece on [Tesla solar panel removal cost](/blog/tesla-solar-panel-removal-cost/) first.

## If this is a hail claim

On a covered hail claim, the detach and reset is typically paid as a line item in the roof insurance claim. What changes with a leased array is the plumbing around that money, because the equipment owner may want to bill the provider, or bill you, or handle the work in-house and invoice separately. Sort out who gets paid at the same time you sort out who does the work, and read [how insurance handles detach and reset](/blog/does-insurance-cover-solar-detach-reset/) before you talk to the adjuster.

## Five things to do this week

1. Find the agreement, or log into the provider's portal and confirm whether it's a lease, a PPA or a loan.
2. Call the provider and ask for their roof replacement process, in writing if they'll send it.
3. Get the fee and the lead time in writing, including the lead time for the reset.
4. Give your roofer the real dates, not the ones you hoped for.
5. Confirm in the roofing contract who is responsible for the reset and what happens if the roof runs long.

If you're not sure which category your system falls in, or you want a written scope to send your provider for approval, call us and we'll walk through it. If it turns out the provider has to do the work, we'll tell you that too. New to all of this, start with [what a solar detach and reset actually involves](/blog/what-is-solar-detach-and-reset/).
